...
if os.path.isfile(virt_root + os.path.sep + virt_file):
    ProjectedFS.PrjDeleteFile(instanceHandle, virt_file, ProjectedFS.PRJ_UPDATE_ALLOW_DIRTY_METADATA |
                              ProjectedFS.PRJ_UPDATE_ALLOW_DIRTY_DATA | ProjectedFS.PRJ_UPDATE_ALLOW_TOMBSTONE)
